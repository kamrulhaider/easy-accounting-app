...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    if (
      user &&
      (user.userRole === "COMPANY_ADMIN" || user.userRole === "COMPANY_USER")
    ) {
      loadDashboardData();
    } else {
      setIsLoading(false);
    ...
    <DashboardLayout>
      <div className="space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 ml-4">
              Dashboard
            </h2>
          ...
          <div className="ml-4 md:ml-0 mr-4">
            <a
              href="https://invoicegenius.makeupcoders.com/"
              target="_blank"
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {summary.summary.activeAccountCount}
                </div>
                <p className="text-xs text-muted-foreground">
                  Operational ledger accounts
                </p>
              </CardContent>
            </Card>
          </div>
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <YAxis
                        ...
                        axisLine={false}
                        tickFormatter={(value) =>
                          formatCurrency(value, user?.company?.currency, {
                            compact: true,
                          })
                        }
                        tick={{ fontSize: 12 } as any}
